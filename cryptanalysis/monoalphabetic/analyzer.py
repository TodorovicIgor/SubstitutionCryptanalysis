...
class Analyzer:
    ...
    def break_cipher(self):
        ...
        while True:
            ...
            # alpha = mapping.freq[a]
            # beta = mapping.freq[a+b]
            ...
            print(a, b)
            print("New key is \t\t", new_key.get_key(), "swapped", mapping.freq[a], "and", mapping.freq[a+b])
            new_distribution.swap_cols_rows(mapping.freq[a], mapping.freq[a+b])  # step 7
